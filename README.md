...
<div style="display: flex; justify-content: space-between; gap: 15px; flex-wrap: wrap; margin-bottom: 30px;">
  <img src="https://github.com/ellenmartinelli/your-image1.jpg" alt="Profile Image" width="300" style="border-radius: 12px; border: 3px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
  <img src="https://github.com/ellenmartinelli/your-image2.jpg" alt="At Work" width="300" style="border-radius: 12px; border: 3px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
</div>

<div style="display: flex; justify-content: space-between; gap: 15px; flex-wrap: wrap;">
  <img src="https://github.com/ellenmartinelli/your-image3.jpg" alt="Outdoor" width="300" style="border-radius: 12px; border: 3px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
  <img src="https://github.com/ellenmartinelli/your-image4.jpg" alt="Hobby" width="300" style="border-radius: 12px; border: 3px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
</div>
