...
<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin: 0; padding: 0; width: 100%;">
  <img src="image1.jpg" alt="Profile Image" width="100%" height="170" style="border-radius: 12px; border: 2px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
  <img src="image2.jpg" alt="At Work" width="100%" height="170" style="border-radius: 12px; border: 2px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
  <img src="image3.jpg" alt="Outdoor" width="100%" height="170" style="border-radius: 12px; border: 2px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
  <img src="image4.jpg" alt="Hobby" width="100%" height="170" style="border-radius: 12px; border: 2px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1);">
</div>
