...
<div style="display: flex; justify-content: space-between; flex-wrap: wrap; margin-bottom: 30px;">
  <img src="image1.jpg" alt="Profile Image" width="220" height="150" style="border-radius: 12px; border: 2px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1); margin-right: 10px;">
  <img src="image2.jpg" alt="At Work" width="220" height="150" style="border-radius: 12px; border: 2px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1); margin-right: 10px;">
  <img src="image3.jpg" alt="Outdoor" width="220" height="150" style="border-radius: 12px; border: 2px solid #ddd; box-shadow: 0px 4px 12px rgba(0,0,0,0.1); margin-right: 10px;">
